...
const Why = () => {
  ...
  return <div className="App">
    ...
    <div style={{ height, width }} className="lodo_main">
      ...
      <div style={{ width: height * .6, height: width * .4, background: 'green', display: 'flex' , flexDirection: 'row' }} className="player_main" >
      ...
      <div style={{ width: height * .6, height: width * .4, background: 'blue', display: 'flex' , flexDirection: 'row' }} className="player_main">
